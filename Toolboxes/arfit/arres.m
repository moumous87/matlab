...
%
%  The use of the LMP statistic with correlation matrices averaged
%  over several realizations is heuristic. It may lead to problems
%  if n is modest and ntr is large.
