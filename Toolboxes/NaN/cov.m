...
% The mean is removed from the data. In case of NaN's, this can 
% case a nonpositive-definite covariance matrix. As an alternative
% use can use corrcoef, which computes pairwise correlations.  
%
% C = COV(X [,Mode]);
...
%	$Id: cov.m 4585 2008-02-04 13:47:45Z adb014 $
