function [und_value]=UndiscountedBlackCapFloor(phi,Fwdrate,Caprate,Vol,OptionMat,tenor)
...
%Undiscounted value
und_value=phi*tenor.*(Fwdrate.*normcdf(phi*D1,0,1)-Caprate.*normcdf(phi*D2,0,1));